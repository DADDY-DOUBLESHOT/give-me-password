...
export default function Generate({ startTimer }) {
      ...
      {show ? (
        <div className="col-12 col-lg-6 form-group d-flex flex-column">
          <div className="d-flex flex-column justify-content-center align-items-center  flex-fill text-center">
            <h5 className="mb-5">Please remember this code as this code will be used for generating encoded password</h5>
        ...
        <div className="col-12 col-lg-6 form-group d-flex flex-column">
          <div className="d-flex flex-column justify-content-center align-items-center  flex-fill text-center">
            ...
            <Image src="/images/or.svg" width={500} height={24} />
